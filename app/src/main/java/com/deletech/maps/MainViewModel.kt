...
import com.deletech.maps.repository.LoginRepository
...
class MainViewModel (application: Application): AndroidViewModel(application){
    ...
    internal var loginRepository:LoginRepository
    ...
    private val signInObservable = MediatorLiveData<Resource<Token>>()
    init {
        ...
        signInObservable.addSource(loginRepository.signInObservable){data->signInObservable.setValue(data)}
    }
    fun login(){
        loginRepository.signIn()
    }
    fun observeSignIn(): LiveData<Resource<Token>>{
